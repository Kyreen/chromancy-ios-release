...
const sections = [
  ...
  },
  {
    ...
    body: `The CHROMANCY wallet uses credits. Wallet top-ups are purchased through the App Store or Google Play at the localized price shown by the store, and each top-up adds ${getWalletTopUpLabel()} to your wallet. AI tools cost per-tool tiers of 12, 20, 39, or 50 credits depending on the tool selected. The premium CREATE tool costs 50 credits. Retry pricing discounts basic AI tools by up to 50% off the original tool cost when you re-run the same tool on the same file, subject to a minimum retry cost of 8 credits — however CREATE is excluded from the retry discount and always costs full price. Before any paid AI feature starts, CHROMANCY shows the exact credit cost. Failed AI generations are refunded or released. Credits have no cash value and are non-transferable. Beam Mode remains free and never uses credits.`,
  },
  {
    title: "5. Exports",
