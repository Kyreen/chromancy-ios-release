...
const sections = [
  ...
  },
  {
    ...
    body: `AI wallet pricing uses per-tool tiers of R12, R20, R39, and R50 depending on the tool selected. The premium CREATE tool costs R50 from wallet funds. Retry pricing discounts basic AI tools by up to 50% off the original tool price when you re-run the same tool on the same file, subject to a minimum retry price of R8 — however CREATE is excluded from the retry discount and always costs full price. Wallet top-ups are ${getWalletTopUpLabel()}. Before any paid AI feature starts, CHROMANCY shows the exact wallet-fund cost. Failed AI generations are refunded or released. Beam Mode remains free and never uses wallet funds.`,
  },
  {
    title: "5. Exports",
