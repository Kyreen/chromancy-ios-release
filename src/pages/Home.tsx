...
export function Home({ onNavigate }: HomeProps) {
  const tools = [
    { id: "fix", icon: Wand2, label: "Polish", color: "from-white via-white to-slate-100", description: "Graphic design — upgrade designs, logos, posters & flyers to look professional." },
      ...
      <section className="grid grid-cols-2 gap-4">
        {tools.map((tool, index) => (
          ...
          >
            ...
            <p className="text-[11px] leading-snug text-white/65 mt-1 line-clamp-4">{tool.description}</p>
