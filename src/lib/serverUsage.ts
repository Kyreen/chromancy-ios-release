...
export async function syncBillingCustomerInfo(payload: Record<string, unknown>): Promise<UsageSnapshot> {
  return postJson<UsageSnapshot>("/api/billing/sync-customer-info", {
    ...getAuthPayload(),
    ...payload,
  });
}
