...
import { auth, completeGoogleRedirectIfPresent, subscribeToUserProfile } from "./lib/firebase";
...
export default function App() {
  ...
  const content = useMemo(() => {
    ...
    switch (activeTab) {
      ...
      case "wallet":
        return <SubscriptionPage user={user} profile={profile} tier={tier} onBack={navigateBack} initialView="unlock" />;
      case "history":
        return <LocalHistoryPage onBack={navigateBack} />;
      case "settings":
        return <Settings user={user} profile={profile} tier={tier} onBack={navigateBack} onNavigate={navigateTo} />;
      case "auth":
      ...
      case "subscribe":
        return <SubscriptionPage user={user} profile={profile} tier={tier} onBack={navigateBack} initialView="premium" />;
      case "dataSafety":
