...
const sections = [
  ...
  },
  {
    ...
    body: `Pro Monthly is ${formatZarUsd(premiumMonthlyPricing.zar)} per month including VAT and includes 40 AI Credits Monthly, Unlimited Beam Mode, No Beam Mode Watermark, and HD Exports. Premium Monthly is R${formatZarAmount(premiumPlan?.monthlyZar || 249.99)} per month including VAT and includes ${premiumPlan?.monthlyAiCredits || 60} AI Credits, Monthly Unlimited Beam Mode, No Beam Mode Watermark, HD Exports, and Priority Processing. AI wallet pricing uses per-tool tiers of R12, R20, and R39 depending on the tool selected. CREATE currently costs R39 from wallet funds or 3 AI Credits from an active subscription. Retry pricing is 50% of the original tool price. Wallet top-ups are ${getWalletTopUpLabel()}. Before any paid AI feature starts, CHROMANCY shows the exact wallet-fund or AI-credit cost. Failed AI generations are refunded or released. Beam Mode remains free and never uses wallet or AI credits.`,
  },
  {
    title: "5. Exports",
