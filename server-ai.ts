...
export async function enhancePhoto(
  ...
  // Cost-optimised: the proven gemini-2.5-flash-image gives comparable results at a
  // lower price than the newer 3.1 preview. Override with CHROMANCY_AI_IMAGE_MODEL.
  const model = process.env.CHROMANCY_AI_IMAGE_MODEL || "gemini-2.5-flash-image";
  const ai = getAI();
